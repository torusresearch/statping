    ...
    <div class="card-body pb-1">
      ...
      >
        <div class="col-md-12 col-sm-12 pl-2 mt-2 mt-md-0 mb-3">
          <ServiceSparkLine
            :title="set2_name"
            subtitle="Latency Last 24 Hours"
            :series="set2"
          />
        </div>
        ...
        <div class="col-7 pr-2 pl-0">
          <div class="btn-group float-right">
            <button
              ...
              @click="$router.push({path: `/dashboard/service/${service.id}/incidents`, params: {id: service.id}})"
            ...
            <button
              ...
              @click="$router.push({path: `/dashboard/service/${service.id}/checkins`, params: {id: service.id}})"
              @mouseleave="unsetHover"
            ...
            <button
              ...
              @click="$router.push({path: `/dashboard/service/${service.id}/failures`, params: {id: service.id}})"
              @mouseleave="unsetHover"
              @mouseover="setHover($t('failures'))"
            >
              <font-awesome-icon icon="exclamation-triangle" />
              <span
                v-if="service.stats.failures !== 0"
...
export default {
    ...
    methods: {
        ...
        async getHits (seconds, group) {
            const start = this.nowSubtract(seconds);
