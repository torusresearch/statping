  ...
  <div class="container mt-md-5">
    ...
    >
      ...
      <span class="mt-2 font-3">
        ...
        >
          {{ core.name }}
        </router-link> - <span class="text-muted">
          {{ service.name }}
        </span>
        <span
          ...
          <div class="row">
            <div class="col">
              <FlatPickr
                v-model="start_time"
                :disabled="!loaded"
                :config="{ wrap: true, allowInput: true, enableTime: true, dateFormat: 'Z', altInput: true, altFormat: 'Y-m-d h:i K', maxDate: this.endOf('today') }"
                type="text"
            ...
            <div class="col">
              ...
              <small class="d-block d-md-none d-block">
                Increment Timeframe
              </small>
            </div>
          </div>
